...
#else
         PythonQtArgumentFrame_ADD_VARIANT_VALUE(frame, QVariant(QMetaType(id)), ptr);
#endif
...
#else
         PythonQtArgumentFrame_ADD_VARIANT_VALUE(frame, QVariant(QMetaType(info.typeId)), ptr);
#endif
         // return the constData pointer that will be filled with the result value later on
         ptr = (void*)((QVariant*)ptr)->constData();
       }
...
#else
               PythonQtArgumentFrame_ADD_VARIANT_VALUE_IF_NEEDED(alreadyAllocatedCPPObject, frame, QVariant(QMetaType(id)), ptr);
#endif
               ptr = (void*)((QVariant*)ptr)->constData();
             } else {
...
#else
               PythonQtArgumentFrame_ADD_VARIANT_VALUE_IF_NEEDED(alreadyAllocatedCPPObject,frame, QVariant(QMetaType(info.typeId)), ptr);
#endif
               ptr = (void*)((QVariant*)ptr)->constData();
             } else {
               ptr = alreadyAllocatedCPPObject;
