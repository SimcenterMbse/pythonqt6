...
public:
   PythonQtShell_QNativeGestureEvent(
      ...
      quint64 sequenceId,
      quint64 intArgument)
      : QNativeGestureEvent(type, dev, localPos, scenePos, globalPos, value, sequenceId, intArgument),
      _wrapper(NULL) {}
    ...
    PythonQtShell_QNativeGestureEvent(
      ...
      qreal value,
      const QPointF &delta,
      quint64 sequenceId = UINT64_MAX)
      : QNativeGestureEvent(type, dev, fingerCount, localPos, scenePos, globalPos, value, delta, sequenceId),
      _wrapper(NULL) {}
...
QNativeGestureEvent* new_QNativeGestureEvent(
      Qt::NativeGestureType type,
      const QPointingDevice *dev,
      const QPointF &localPos,
      const QPointF &scenePos,
