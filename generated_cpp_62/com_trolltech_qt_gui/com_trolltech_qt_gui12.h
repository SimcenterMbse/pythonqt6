...
class PythonQtPublicPromoter_QUndoView : public QUndoView
{
public:
...
void delete_QUndoView(QUndoView* obj) { delete obj; } 
   ...
   void initViewItemOption(QUndoView *self, QStyleOptionViewItem *option) const;
...
{
public:
PythonQtShell_QWheelEvent(const QPointF &pos, const QPointF &globalPos, QPoint pixelDelta, QPoint angleDelta,
...
public:
public slots:
QWheelEvent* new_QWheelEvent(const QPointF &pos, const QPointF &globalPos, QPoint pixelDelta, QPoint angleDelta,
                Qt::MouseButtons buttons, Qt::KeyboardModifiers modifiers, Qt::ScrollPhase phase,
                bool inverted, Qt::MouseEventSource source = Qt::MouseEventNotSynthesized,
                const QPointingDevice *device = QPointingDevice::primaryPointingDevice());
...
public slots:
   ...
   QKeyCombination *new_QKeyCombination(Qt::Modifiers modifiers, Qt::Key key = Qt::Key_unknown);
   QKeyCombination *new_QKeyCombination(Qt::Key key = Qt::Key_unknown);
   Qt::Key key(QKeyCombination *self) const;
   Qt::KeyboardModifiers keyboardModifiers(QKeyCombination *self) const;
   int toCombined(QKeyCombination *self) const;

   QKeyCombination *static_QKeyCombination_fromCombined(int combined);

   bool __ne__(QKeyCombination *self, const QKeyCombination &other) const;
   bool __eq__(QKeyCombination *self, const QKeyCombination &other) const;
};
