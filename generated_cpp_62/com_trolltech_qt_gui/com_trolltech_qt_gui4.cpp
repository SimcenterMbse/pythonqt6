...
void PythonQtShell_QListView::initViewItemOption(QStyleOptionViewItem *option) const
{
   if (_wrapper != nullptr)
   {
      PYTHONQT_GIL_SCOPE
...
void PythonQtWrapper_QListView::initViewItemOption(QListView *self, QStyleOptionViewItem *option) const
{
   ((const PythonQtPublicPromoter_QListView *)self)->promoted_initViewItemOption(option);
}
