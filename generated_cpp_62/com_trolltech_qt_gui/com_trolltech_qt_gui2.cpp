...
QStringList PythonQtWrapper_QFontDatabase::static_QFontDatabase_families(QFontDatabase::WritingSystem writingSystem /*= QFontDatabase::Any*/)
{
...
QList<int> PythonQtWrapper_QFontDatabase::static_QFontDatabase_pointSizes(const QString &family, const QString &style /*= QString()*/)
{
...
bool PythonQtWrapper_QFontDatabase::static_QFontDatabase_isBitmapScalable(const QString &family, const QString &style /*= QString()*/)
{
   return QFontDatabase::isBitmapScalable(family, style);
}

bool PythonQtWrapper_QFontDatabase::static_QFontDatabase_isSmoothlyScalable(const QString &family, const QString &style /*= QString()*/)
{
   return QFontDatabase::isSmoothlyScalable(family, style);
}

bool PythonQtWrapper_QFontDatabase::static_QFontDatabase_isScalable(const QString &family, const QString &style /*= QString()*/)
{
   return QFontDatabase::isScalable(family, style);
}

bool PythonQtWrapper_QFontDatabase::static_QFontDatabase_isFixedPitch(const QString &family, const QString &style /*= QString()*/)
{
