...
void PythonQtShell_QUndoView::initViewItemOption(QStyleOptionViewItem *option) const
{
   if (_wrapper != nullptr)
   {
      PYTHONQT_GIL_SCOPE
...
void PythonQtWrapper_QUndoView::initViewItemOption(QUndoView *self, QStyleOptionViewItem *option) const
{
((const PythonQtPublicPromoter_QUndoView *)self)->promoted_initViewItemOption(option);
}
...
QKeyCombination *PythonQtWrapper_QKeyCombination::new_QKeyCombination(
...
Qt::Key PythonQtWrapper_QKeyCombination::key(QKeyCombination *self) const
{
   return self->key();
}

Qt::KeyboardModifiers PythonQtWrapper_QKeyCombination::keyboardModifiers(
   QKeyCombination *self) const
{
   return self->keyboardModifiers();
}

int PythonQtWrapper_QKeyCombination::toCombined(QKeyCombination *self) const
{
...
bool PythonQtWrapper_QKeyCombination::__ne__(
   QKeyCombination *self,
   const QKeyCombination &other) const
{
   return *self != other;
}

bool PythonQtWrapper_QKeyCombination::__eq__(
   QKeyCombination *self,
   const QKeyCombination &other) const
{
   return *self == other;
