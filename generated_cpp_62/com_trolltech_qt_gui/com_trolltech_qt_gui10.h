...
void delete_QTableView(QTableView* obj) { delete obj; } 
   ...
   void initViewItemOption(QTableView *self, QStyleOptionViewItem *option) const;
...
{
public:
    PythonQtShell_QTabletEvent(QEvent::Type t, const QPointingDevice *device,
                 ...
                 : QTabletEvent(t, device, pos, globalPos, pressure, xTilt, yTilt, tangentialPressure, rotation, z, keyState, button, buttons),
                 _wrapper(NULL){}
...
public:
public slots:
QTabletEvent* new_QTabletEvent(QEvent::Type t, const QPointingDevice *device,
                 const QPointF &pos, const QPointF &globalPos,
                 qreal pressure, float xTilt, float yTilt,
                 float tangentialPressure, qreal rotation, float z,
                 Qt::KeyboardModifiers keyState,
...
void delete_QTabletEvent(QTabletEvent* obj) { delete obj; } 
   ...
   const QInputDevice *  device(QTabletEvent* theWrappedObject) const;
