...
void delete_QSortFilterProxyModel(QSortFilterProxyModel* obj) { delete obj; } 
   ...
   void setFilterRegularExpression(QSortFilterProxyModel* theWrappedObject, const QRegularExpression&  regExp);
...
{
public:
    PythonQtShell_QSplashScreen(QScreen*  parent, const QPixmap&  pixmap = QPixmap(), Qt::WindowFlags  f = Qt::WindowFlags()):QSplashScreen(parent, pixmap, f),_wrapper(NULL) {};
...
public:
public slots:
QSplashScreen* new_QSplashScreen(QScreen*  parent, const QPixmap&  pixmap = QPixmap(), Qt::WindowFlags  f = Qt::WindowFlags());
