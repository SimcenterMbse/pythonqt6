...
void PythonQtWrapper_QSortFilterProxyModel::setFilterRegularExpression(QSortFilterProxyModel* theWrappedObject, const QRegularExpression&  regExp)
{
  ( theWrappedObject->setFilterRegularExpression(regExp));
}
...
QSplashScreen* PythonQtWrapper_QSplashScreen::new_QSplashScreen(QScreen*  parent, const QPixmap&  pixmap, Qt::WindowFlags  f)
{ 
