...
void delete_QTextLine(QTextLine* obj) { delete obj; } 
   ...
   void draw(QTextLine* theWrappedObject, QPainter*  p, const QPointF&  point) const;
...
void delete_QTextList(QTextList* obj) { delete obj; } 
   ...
   void setFormat(QTextList* theWrappedObject, const QTextListFormat&  format);
    bool __nonzero__(QTextList* obj) { return obj->count() != 0; }
};
...
virtual void dragMoveEvent(QDragMoveEvent*  event);
virtual void dropEvent(QDropEvent*  event);
virtual void enterEvent(QEnterEvent*  arg__1);
virtual bool  event(QEvent*  e);
virtual bool  eventFilter(QObject*  watched, QEvent*  event);
...
{
public:
    PythonQtShell_QTouchEvent(QEvent::Type  eventType, const QPointingDevice*  device = NULL, Qt::KeyboardModifiers  modifiers = Qt::NoModifier, const QList<QEventPoint >&  touchPoints = QList<QTouchEvent::TouchPoint>()):QTouchEvent(eventType, device, modifiers, touchPoints),_wrapper(NULL) {};
...
public:
public slots:
QTouchEvent* new_QTouchEvent(QEvent::Type  eventType, const QPointingDevice*  device = NULL, Qt::KeyboardModifiers  modifiers = Qt::NoModifier, const QList<QTouchEvent::TouchPoint >&  touchPoints = QList<QTouchEvent::TouchPoint>());
void delete_QTouchEvent(QTouchEvent* obj) { delete obj; } 
   const QInputDevice*  device(QTouchEvent* theWrappedObject) const;
...
void delete_QTouchEvent__TouchPoint(QTouchEvent::TouchPoint* obj) { delete obj; }
   ...
   QEventPoint::State  state(QTouchEvent::TouchPoint* theWrappedObject) const;
...
inline void promoted_initViewItemOption(QStyleOptionViewItem *option) const
{
...
void delete_QTreeView(QTreeView* obj) { delete obj; } 
   ...
   void initViewItemOption(QTreeView* self, QStyleOptionViewItem *option) const;
