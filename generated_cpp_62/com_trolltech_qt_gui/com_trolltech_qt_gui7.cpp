...
bool PythonQtShell_QPrinter::setPageSize(const QPageSize  &arg__1)
{
if (_wrapper) {
  PYTHONQT_GIL_SCOPE
  if (((PyObject*)_wrapper)->ob_refcnt > 0) {
    ...
    PyObject* obj = PyBaseObject_Type.tp_getattro((PyObject*)_wrapper, name);
    if (obj) {
      static const char* argumentList[] ={"bool" , "const PageSize&"};
      static const PythonQtMethodInfo* methodInfo = PythonQtMethodInfo::getCachedMethodInfoFromArgumentList(2, argumentList);
  ...
  return QPrinter::setPageSize(arg__1);
}
...
void PythonQtWrapper_QPrinter::setPageMargins(QPrinter* theWrappedObject, const QMarginsF &margins, QPageLayout::Unit units /*= QPageLayout::Millimeter*/)
{
  ( theWrappedObject->setPageMargins(margins, units));
}
