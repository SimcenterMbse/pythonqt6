...
virtual QPaintEngine*  paintEngine() const;
virtual QPaintDevice*  redirected(QPoint*  offset) const;
virtual bool setPageSize(const QPageSize &arg__1);
virtual QPainter*  sharedPainter() const;
...
void delete_QPrinter(QPrinter* obj) { delete obj; } 
   ...
   void setPageMargins(QPrinter* theWrappedObject, const QMarginsF &margins, QPageLayout::Unit units = QPageLayout::Millimeter);
