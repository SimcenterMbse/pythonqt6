...
void delete_QAbstractItemView(QAbstractItemView* obj) { delete obj; }
   ...
   void initViewItemOption(QAbstractItemView *self, QStyleOptionViewItem *option) const;
...
void delete_QColumnView(QColumnView* obj) { delete obj; } 
   ...
   void initViewItemOption(QColumnView *self, QStyleOptionViewItem *option) const;
