...
void PythonQtShell_QAbstractItemView::initViewItemOption(QStyleOptionViewItem *option) const
{
   if (_wrapper != nullptr)
   {
      PYTHONQT_GIL_SCOPE
...
void PythonQtWrapper_QAbstractItemView::initViewItemOption(QAbstractItemView *self, QStyleOptionViewItem *option) const
{
((const PythonQtPublicPromoter_QAbstractItemView *)self)->promoted_initViewItemOption(option);
}
...
void PythonQtShell_QColumnView::initViewItemOption(QStyleOptionViewItem *option) const
{
   if (_wrapper != nullptr)
   {
      PYTHONQT_GIL_SCOPE
...
void PythonQtWrapper_QColumnView::initViewItemOption(QColumnView *self, QStyleOptionViewItem *option) const
{
((const PythonQtPublicPromoter_QColumnView *)self)->promoted_initViewItemOption(option);
}
