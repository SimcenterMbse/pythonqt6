...
void PythonQtWrapper_QTextLine::draw(QTextLine* theWrappedObject, QPainter*  p, const QPointF&  point) const
{
  ( theWrappedObject->draw(p, point));
}
...
const QInputDevice*  PythonQtWrapper_QTouchEvent::device(QTouchEvent* theWrappedObject) const
{
...
QEventPoint::State  PythonQtWrapper_QTouchEvent__TouchPoint::state(QTouchEvent::TouchPoint* theWrappedObject) const
{
...
void PythonQtShell_QTreeView::initViewItemOption(QStyleOptionViewItem *option) const
{
   if (_wrapper != nullptr)
   {
      PYTHONQT_GIL_SCOPE
...
void PythonQtWrapper_QTreeView::initViewItemOption(QTreeView *self, QStyleOptionViewItem *option) const
{
   ((const PythonQtPublicPromoter_QTreeView *)self)->promoted_initViewItemOption(option);
}
