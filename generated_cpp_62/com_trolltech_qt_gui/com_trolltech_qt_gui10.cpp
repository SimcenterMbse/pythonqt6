...
void PythonQtShell_QTableView::initViewItemOption(QStyleOptionViewItem *option) const
{
   if (_wrapper != nullptr)
   {
      PYTHONQT_GIL_SCOPE
...
void PythonQtWrapper_QTableView::initViewItemOption(QTableView *self, QStyleOptionViewItem *option) const
{
((const PythonQtPublicPromoter_QTableView *)self)->promoted_initViewItemOption(option);
}
...
const QInputDevice *  PythonQtWrapper_QTabletEvent::device(QTabletEvent* theWrappedObject) const
{
