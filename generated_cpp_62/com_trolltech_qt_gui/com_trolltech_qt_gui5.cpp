...
QNativeGestureEvent *PythonQtWrapper_QNativeGestureEvent::new_QNativeGestureEvent(Qt::NativeGestureType type, const QPointingDevice *dev, const QPointF &mlocalPos, const QPointF &mscenePos, const QPointF &mglobalPos, qreal value, quint64 sequenceId, quint64 intArgument)
{
   return new PythonQtShell_QNativeGestureEvent(type, dev, mlocalPos, mscenePos, mglobalPos, value, sequenceId, intArgument);
}

QNativeGestureEvent *PythonQtWrapper_QNativeGestureEvent::new_QNativeGestureEvent(Qt::NativeGestureType type, const QPointingDevice *dev, int fingerCount, const QPointF &mlocalPos, const QPointF &mscenePos, const QPointF &mglobalPos, qreal value, const QPointF &delta, quint64 sequenceId /*= UINT64_MAX*/)
{
   return new PythonQtShell_QNativeGestureEvent(type, dev, fingerCount, mlocalPos, mscenePos, mglobalPos, value, delta, sequenceId);
}
