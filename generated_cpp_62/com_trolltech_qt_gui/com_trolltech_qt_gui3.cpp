...
void PythonQtShell_QHeaderView::initViewItemOption(QStyleOptionViewItem *option) const
{
   if (_wrapper != nullptr)
   {
      PYTHONQT_GIL_SCOPE
...
void PythonQtWrapper_QHeaderView::initViewItemOption(QHeaderView *self, QStyleOptionViewItem *option) const
{
((const PythonQtPublicPromoter_QHeaderView *)self)->promoted_initViewItemOption(option);
}
