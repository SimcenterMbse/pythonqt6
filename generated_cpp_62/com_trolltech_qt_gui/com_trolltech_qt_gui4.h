...
{
public:
    PythonQtShell_QInputEvent(QEvent::Type  type, const QInputDevice *m_dev, Qt::KeyboardModifiers  modifiers = Qt::NoModifier):QInputEvent(type, m_dev, modifiers),_wrapper(NULL) {};
...
void delete_QListView(QListView* obj) { delete obj; } 
   ...
   void initViewItemOption(QListView *self, QStyleOptionViewItem *option) const;
