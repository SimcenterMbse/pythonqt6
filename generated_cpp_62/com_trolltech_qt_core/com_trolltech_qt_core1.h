...
public:
   ...
   enum LibraryPath
   {
      ...
      QmlImportsPath = QLibraryInfo::QmlImportsPath,
...
public slots:
   ...
   QString static_QLibraryInfo_path(QLibraryInfo::LibraryPath arg__1);
...
void delete_QMetaType(QMetaType* obj) { delete obj; } 
   ...
   bool  static_QMetaType_hasRegisteredConverterFunction(QMetaType  fromTypeId, QMetaType  toTypeId);
   ...
   void  static_QMetaType_registerNormalizedTypedef(const QByteArray&  normalizedTypeName, QMetaType  aliasId);
