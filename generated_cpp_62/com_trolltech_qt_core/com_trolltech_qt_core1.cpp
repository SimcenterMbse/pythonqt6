...
QString PythonQtWrapper_QLibraryInfo::static_QLibraryInfo_path(QLibraryInfo::LibraryPath arg__1)
{
   return QLibraryInfo::path(arg__1);
}
...
bool  PythonQtWrapper_QMetaType::static_QMetaType_hasRegisteredConverterFunction(QMetaType  fromTypeId, QMetaType  toTypeId)
{
...
void  PythonQtWrapper_QMetaType::static_QMetaType_registerNormalizedTypedef(const QByteArray&  normalizedTypeName, QMetaType  aliasId)
{
  QMetaType::registerNormalizedTypedef(normalizedTypeName, aliasId);
}
