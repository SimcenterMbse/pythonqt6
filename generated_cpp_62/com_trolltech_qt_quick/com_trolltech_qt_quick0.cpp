...
void PythonQtWrapper_QQuickRenderControl::initialize(QQuickRenderControl* theWrappedObject)
{
  ( theWrappedObject->initialize());
}
...
void PythonQtWrapper_QSGRendererInterface::delete_QSGRendererInterface(QSGRendererInterface *self)
{
   delete self;
}

void *PythonQtWrapper_QSGRendererInterface::getResource(QSGRendererInterface *self, QQuickWindow *window, QSGRendererInterface::Resource resource) const
{
   return self->getResource(window, resource);
}

void *PythonQtWrapper_QSGRendererInterface::getResource(QSGRendererInterface *self, QQuickWindow *window, const char *resource) const
{
   return self->getResource(window, resource);
}
