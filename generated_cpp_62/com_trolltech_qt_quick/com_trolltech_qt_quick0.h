...
public:
   Q_ENUMS(GraphicsApi Resource ShaderType ShaderCompilationType ShaderSourceType RenderMode)
   Q_FLAGS(ShaderSourceTypes ShaderCompilationTypes)
   ...
   enum Resource
   {
      DeviceResource = QSGRendererInterface::DeviceResource,
      CommandQueueResource = QSGRendererInterface::CommandQueueResource,
      CommandListResource = QSGRendererInterface::CommandListResource,
      PainterResource = QSGRendererInterface::PainterResource,
      RhiResource = QSGRendererInterface::RhiResource,
      RhiSwapchainResource = QSGRendererInterface::RhiSwapchainResource,
      RhiRedirectCommandBuffer = QSGRendererInterface::RhiRedirectCommandBuffer,
      RhiRedirectRenderTarget = QSGRendererInterface::RhiRedirectRenderTarget,
      PhysicalDeviceResource = QSGRendererInterface::PhysicalDeviceResource,
      OpenGLContextResource = QSGRendererInterface::OpenGLContextResource,
      DeviceContextResource = QSGRendererInterface::DeviceContextResource,
      CommandEncoderResource = QSGRendererInterface::CommandEncoderResource,
      VulkanInstanceResource = QSGRendererInterface::VulkanInstanceResource,
      RenderPassResource = QSGRendererInterface::RenderPassResource
   };
   ...
   enum RenderMode
   {
      RenderMode2D = QSGRendererInterface::RenderMode2D,
      RenderMode2DNoDepthBuffer = QSGRendererInterface::RenderMode2DNoDepthBuffer,
      RenderMode3D = QSGRendererInterface::RenderMode3D
   };
...
public slots:
   void delete_QSGRendererInterface(QSGRendererInterface *self);

   void *getResource(QSGRendererInterface *self, QQuickWindow *window, QSGRendererInterface::Resource resource) const;
   void *getResource(QSGRendererInterface *self, QQuickWindow *window, const char *resource) const;
...
void delete_QQuickRenderControl(QQuickRenderControl* obj) { delete obj; } 
   void initialize(QQuickRenderControl* theWrappedObject);
