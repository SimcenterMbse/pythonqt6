...
QBitmap PythonQtWrapper_QBitmap::static_QBitmap_fromPixmap(const QPixmap &pix)
{
   return QBitmap::fromPixmap(pix);
}
...
void PythonQtWrapper_QFont::setWeight(QFont* theWrappedObject, Weight  arg__1)
{
  ( theWrappedObject->setWeight(QFont::Weight(arg__1)));
}
...
PythonQtWrapper_QFont::Weight PythonQtWrapper_QFont::weight(QFont* theWrappedObject) const
{
  return Weight( theWrappedObject->weight());
}
...
QPixmap PythonQtWrapper_QIcon::pixmap(QIcon *theWrappedObject, const QSize &size, qreal devicePixelRatio, QIcon::Mode mode /*= Normal*/, QIcon::State state /*= Off*/) const
{
...
QImage PythonQtWrapper_QImage::convertedTo(QImage *self, QImage::Format format, Qt::ImageConversionFlags flags) const
{
   return self->convertedTo(format, flags);
}

void PythonQtWrapper_QImage::mirror(QImage *self, bool horizontal, bool vertical)
{
   self->mirror(horizontal, vertical);
}

void PythonQtWrapper_QImage::rgbSwap(QImage *self)
{
   self->rgbSwap();
}
