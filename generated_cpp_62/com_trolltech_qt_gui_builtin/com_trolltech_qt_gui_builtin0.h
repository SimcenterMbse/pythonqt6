...
void delete_QBitmap(QBitmap* obj) { delete obj; } 
   ...
   QBitmap static_QBitmap_fromPixmap(const QPixmap &pix);
...
void delete_QColor(QColor* obj) { delete obj; } 
   ...
   void getHslF(QColor* theWrappedObject, float*  h, float*  s, float*  l, float*  a = NULL) const;
...
enum StyleStrategy{
  PreferDefault = QFont::PreferDefault,   PreferBitmap = QFont::PreferBitmap,   PreferDevice = QFont::PreferDevice,   PreferOutline = QFont::PreferOutline,   ForceOutline = QFont::ForceOutline,   PreferMatch = QFont::PreferMatch,   PreferQuality = QFont::PreferQuality,   PreferAntialias = QFont::PreferAntialias,   NoAntialias = QFont::NoAntialias,   NoSubpixelAntialias = QFont::NoSubpixelAntialias,   NoFontMerging = QFont::NoFontMerging};
enum Weight
{
   Thin = QFont::Thin,
...
void delete_QFont(QFont* obj) { delete obj; } 
   ...
   void setWeight(QFont* theWrappedObject, Weight  arg__1);
   ...
   Weight  weight(QFont* theWrappedObject) const;
...
PyObject* constScanLine(QImage* image, int line) {
  return PythonQtPrivate::wrapMemoryAsBuffer(image->constScanLine(line), image->bytesPerLine());
   ...
   QImage convertedTo(QImage *self, QImage::Format format, Qt::ImageConversionFlags flags) const;
   void mirror(QImage *self, bool horizontal, bool vertical);
   void rgbSwap(QImage *self);
};
