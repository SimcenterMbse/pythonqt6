...
void delete_QDomDocument(QDomDocument* obj) { delete obj; } 
   ...
   bool setContent(QDomDocument* theWrappedObject, QXmlStreamReader *reader, bool namespaceProcessing, QString *errorMsg = nullptr,
...
void delete_QDomNode(QDomNode* obj) { delete obj; } 
   ...
   QDomNamedNodeMap attributes(QDomNode* theWrappedObject) const;
