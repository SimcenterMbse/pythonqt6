...
bool PythonQtWrapper_QDomDocument::setContent(QDomDocument* theWrappedObject, QXmlStreamReader *reader, bool namespaceProcessing, QString *errorMsg /*= nullptr*/, int *errorLine /*= nullptr*/, int *errorColumn /*= nullptr*/)
{
...
QDomNamedNodeMap PythonQtWrapper_QDomNode::attributes(QDomNode *theWrappedObject) const
{
   return theWrappedObject->attributes();
}
