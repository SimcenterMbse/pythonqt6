...
enum SslProtocol{
  TlsV1_0 = QSsl::TlsV1_0,   TlsV1_1 = QSsl::TlsV1_1,   TlsV1_2 = QSsl::TlsV1_2,   AnyProtocol = QSsl::AnyProtocol,   SecureProtocols = QSsl::SecureProtocols,   TlsV1_0OrLater = QSsl::TlsV1_0OrLater,   TlsV1_1OrLater = QSsl::TlsV1_1OrLater,   TlsV1_2OrLater = QSsl::TlsV1_2OrLater,   UnknownProtocol = QSsl::UnknownProtocol};
...
{ Q_OBJECT
public:
Q_ENUMS(SubjectInfo PatternSyntax)
enum SubjectInfo{
...
enum PatternSyntax
{
   RegularExpression = QSslCertificate::PatternSyntax::RegularExpression,
   Wildcard = QSslCertificate::PatternSyntax::Wildcard,
   FixedString = QSslCertificate::PatternSyntax::FixedString
};
public slots:
