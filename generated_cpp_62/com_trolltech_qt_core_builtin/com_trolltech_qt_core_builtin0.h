...
public:
   Q_ENUMS(System PlaceHolder)

   enum System
   {
      Gregorian = QCalendar::System::Gregorian,
#ifndef QT_BOOTSTRAPPED
      Julian = QCalendar::System::Julian,
      Milankovic = QCalendar::System::Milankovic,
#endif

#if QT_CONFIG(jalalicalendar)
      Jalali = QCalendar::System::Jalali,
#endif
#if QT_CONFIG(islamiccivilcalendar)
      IslamicCivil = QCalendar::System::IslamicCivil,
#endif
      Last = QCalendar::System::Last,
      User = QCalendar::System::User
   };
   enum PlaceHolder {Unspecified = QCalendar::Unspecified};

public slots:
    QCalendar *new_QCalendar();
    QCalendar *new_QCalendar(System system);
    QCalendar *new_QCalendar(const QString &name);
    void delete_QCalendar(QCalendar *self);

    bool isValid(QCalendar *self) const;

    int daysInMonth(QCalendar *self, int month, int year = Unspecified) const;
    int daysInYear(QCalendar *self, int year) const;
    int monthsInYear(QCalendar *self, int year) const;
    bool isDateValid(QCalendar *self, int year, int month, int day) const;
    bool isLeapYear(QCalendar *self, int year) const;
    bool isGregorian(QCalendar *self) const;
    bool isLunar(QCalendar *self) const;
    bool isLuniSolar(QCalendar *self) const;
    bool isSolar(QCalendar *self) const;
    bool isProleptic(QCalendar *self) const;
    bool hasYearZero(QCalendar *self) const;
    int maximumDaysInMonth(QCalendar *self) const;
    int minimumDaysInMonth(QCalendar *self) const;
    int maximumMonthsInYear(QCalendar *self) const;
    QString name(QCalendar *self) const;
    QDate dateFromParts(QCalendar *self, int year, int month, int day) const;
    int dayOfWeek(QCalendar *self, const QDate &date) const;
...
public slots:
   ...
   QDate *new_QDate(int  y, int  m, int  d, const QCalendar &cal);
   QDate *new_QDate(const QDate& other);

   void delete_QDate(QDate* obj);
   ...
   bool setDate(QDate *theWrappedObject, int year, int month, int day, const QCalendar &cal);
   int day(QDate *self, const QCalendar &cal) const;
   int day(QDate *theWrappedObject) const;
   int dayOfWeek(QDate *self, const QCalendar &cal) const;
   int dayOfWeek(QDate *theWrappedObject) const;
   int dayOfYear(QDate *self, const QCalendar &cal) const;
   int dayOfYear(QDate *theWrappedObject) const;
   int daysInMonth(QDate *self, const QCalendar &cal) const;
   int daysInMonth(QDate *theWrappedObject) const;
   int daysInYear(QDate *self, const QCalendar &cal) const;
   int daysInYear(QDate *theWrappedObject) const;
   int month(QDate *self, const QCalendar &cal) const;
   int month(QDate *theWrappedObject) const;
   int weekNumber(QDate *theWrappedObject, int *yearNum = NULL) const;
   int year(QDate *self, const QCalendar &cal) const;
   ...
   QDate addMonths(QDate *theWrappedObject, int  months, const QCalendar &cal) const;
   QDate addYears(QDate *theWrappedObject, int  years) const;
   QDate addYears(QDate *theWrappedObject, int  years, const QCalendar &cal) const;
   ...
   QString toString(QDate *theWrappedObject, const QString &format, const QCalendar &cal) const;
   ...
   QDate static_QDate_fromString(const QString &s, const QString &format, const QCalendar &cal);
...
void delete_QRect(QRect* obj) { delete obj; } 
   ...
   QRect span(QRect *self, const QPoint &p1, const QPoint &p2);
};
...
enum MatchFlag{
  MatchExactly = Qt::MatchExactly,   MatchContains = Qt::MatchContains,   MatchStartsWith = Qt::MatchStartsWith,   MatchEndsWith = Qt::MatchEndsWith,   MatchWildcard = Qt::MatchWildcard,   MatchFixedString = Qt::MatchFixedString,   MatchCaseSensitive = Qt::MatchCaseSensitive,   MatchWrap = Qt::MatchWrap,   MatchRecursive = Qt::MatchRecursive};
enum MouseButton{
