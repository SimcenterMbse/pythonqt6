...
{
  return theWrappedObject->append(s.toUtf8());
}
...
{
  return &( theWrappedObject->insert(i, s.toUtf8()));
}
...
QDate *PythonQtWrapper_QDate::new_QDate(int y, int m, int d, const QCalendar &cal)
{
   return new QDate(y ,m, d, cal);
}

QDate *PythonQtWrapper_QDate::new_QDate(const QDate &other)
{
   QDate* a = new QDate();
   *a = other;
   return a;
...
void PythonQtWrapper_QDate::delete_QDate(QDate *obj)
{
   delete obj;
}
...
QDate PythonQtWrapper_QDate::addMonths(QDate *theWrappedObject, int months, const QCalendar &cal) const
{
...
QDate PythonQtWrapper_QDate::addYears(QDate *theWrappedObject, int years, const QCalendar &cal) const
{
...
int PythonQtWrapper_QDate::day(QDate *self, const QCalendar &cal) const
{
   return self->day(cal);
}
...
int PythonQtWrapper_QDate::dayOfWeek(QDate *self, const QCalendar &cal) const
{
...
int PythonQtWrapper_QDate::dayOfYear(QDate *self, const QCalendar &cal) const
{
...
int PythonQtWrapper_QDate::daysInMonth(QDate *self, const QCalendar &cal) const
{
...
int PythonQtWrapper_QDate::daysInYear(QDate *self, const QCalendar &cal) const
{
...
QDate PythonQtWrapper_QDate::static_QDate_fromString(const QString &s, const QString &format, const QCalendar &cal)
{
...
int PythonQtWrapper_QDate::month(QDate *self, const QCalendar &cal) const
{
...
QDateTime PythonQtWrapper_QDate::startOfDay(
   QDate *theWrappedObject,
...
QDateTime PythonQtWrapper_QDate::endOfDay(
   QDate *theWrappedObject,
   Qt::TimeSpec spec /*= Qt::LocalTime*/,
   int offsetSeconds /*= 0*/) const
{
...
bool PythonQtWrapper_QDate::setDate(QDate *theWrappedObject, int year, int month, int day, const QCalendar &cal)
{
...
QString PythonQtWrapper_QDate::toString(QDate *theWrappedObject, const QString &format, const QCalendar &cal) const
{
...
int PythonQtWrapper_QDate::year(QDate *self, const QCalendar &cal) const
{
...
bool PythonQtWrapper_QDate::__nonzero__(QDate *obj)
{
   return obj->isValid();
}
...
QRect PythonQtWrapper_QRect::span(QRect *self, const QPoint &p1, const QPoint &p2)
{
   return self->span(p1, p2);
}
...
QCalendar *PythonQtWrapper_QCalendar::new_QCalendar(System system)
{
   return new QCalendar(QCalendar::System(system));
}

QCalendar *PythonQtWrapper_QCalendar::new_QCalendar(const QString &name)
{
   return new QCalendar(name);
}

void PythonQtWrapper_QCalendar::delete_QCalendar(QCalendar *self)
{
   delete self;
}

bool PythonQtWrapper_QCalendar::isValid(QCalendar *self) const
{
   return self->isValid();
}

int PythonQtWrapper_QCalendar::daysInMonth(QCalendar *self, int month, int year /*= Unspecified*/) const
{
   return self->daysInMonth(month, year);
}

int PythonQtWrapper_QCalendar::daysInYear(QCalendar *self, int year) const
{
   return self->daysInYear(year);
}

int PythonQtWrapper_QCalendar::monthsInYear(QCalendar *self, int year) const
{
   return self->monthsInYear(year);
}

bool PythonQtWrapper_QCalendar::isDateValid(QCalendar *self, int year, int month, int day) const
{
   return self->isDateValid(year, month, day);
}

bool PythonQtWrapper_QCalendar::isLeapYear(QCalendar *self, int year) const
{
   return self->isLeapYear(year);
}

bool PythonQtWrapper_QCalendar::isGregorian(QCalendar *self) const
{
   return self->isGregorian();
}

bool PythonQtWrapper_QCalendar::isLunar(QCalendar *self) const
{
   return self->isLunar();
}

bool PythonQtWrapper_QCalendar::isLuniSolar(QCalendar *self) const
{
   return self->isLuniSolar();
}

bool PythonQtWrapper_QCalendar::isSolar(QCalendar *self) const
{
   return self->isSolar();
}

bool PythonQtWrapper_QCalendar::isProleptic(QCalendar *self) const
{
   return self->isProleptic();
}

bool PythonQtWrapper_QCalendar::hasYearZero(QCalendar *self) const
{
   return self->hasYearZero();
}

int PythonQtWrapper_QCalendar::maximumDaysInMonth(QCalendar *self) const
{
   return self->maximumDaysInMonth();
}

int PythonQtWrapper_QCalendar::minimumDaysInMonth(QCalendar *self) const
{
   return self->minimumDaysInMonth();
}

int PythonQtWrapper_QCalendar::maximumMonthsInYear(QCalendar *self) const
{
   return self->maximumMonthsInYear();
}

QString PythonQtWrapper_QCalendar::name(QCalendar *self) const
{
   return self->name();
}

QDate PythonQtWrapper_QCalendar::dateFromParts(QCalendar *self, int year, int month, int day) const
{
   return self->dateFromParts(year, month, day);
}

int PythonQtWrapper_QCalendar::dayOfWeek(QCalendar *self, const QDate &date) const
{
   return self->dayOfWeek(date);
}

QString PythonQtWrapper_QCalendar::monthName(
   QCalendar *self,
...
{
   return self->monthName(locale, month, year, format);
}

QString PythonQtWrapper_QCalendar::standaloneMonthName(
   QCalendar *self,
   const QLocale &locale,
   int month,
   int year /*= Unspecified*/,
   QLocale::FormatType format /*= QLocale::LongFormat*/) const
{
   return self->standaloneMonthName(locale, month, year, format);
}

QString PythonQtWrapper_QCalendar::weekDayName(
   QCalendar *self,
   const QLocale &locale,
   int day,
   QLocale::FormatType format /*= QLocale::LongFormat*/) const
{
   return self->weekDayName(locale, day, format);
}

QString PythonQtWrapper_QCalendar::standaloneWeekDayName(
   QCalendar *self,
   const QLocale &locale,
   int day,
   QLocale::FormatType format /*= QLocale::LongFormat*/) const
{
   return self->standaloneWeekDayName(locale, day, format);
}
